...
pro Kaktovik_cleanup, misc, log
	...
	comms_wrapper, fport, dll, type='moxa', /close, err=err
...
;\\ MIRROR ROUTINES
pro Kaktovik_mirror,  drive_to_pos = drive_to_pos, $
...
pro Kaktovik_filter, filter_number, $
					    log_path = log_path, $
				  	    misc, $
				  	    log
...
pro Kaktovik_initialise, misc, console
